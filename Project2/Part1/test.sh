...
/usr/local/spark/bin/spark-submit --master=spark://$SPARK_MASTER:7077 ./toxic_comment_lr.py hdfs://$SPARK_MASTER:9000/toxic_comment/input/train.csv hdfs://$SPARK_MASTER:9000/toxic_comment/input/test.csv hdfs://$SPARK_MASTER:9000/toxic_comment/input/test_labels.csv
